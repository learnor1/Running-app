<template>
	<view class="page-container">
		<!-- 学校 -->
		<view class="schoolSelect" @click="goSelcetSchool">
			<view class="iconfont icon-24gl-school icon"></view>
			<text class="schoolText">{{store.SchoolName}}</text>
		</view>
		<!-- 轮播图 -->
...
<script setup>
	...
	// 加载完毕
	onLoad(async() => {
		if(uni.getStorageSync('schoolId')) {store.SchoolId=uni.getStorageSync('schoolId');store.SchoolName=uni.getStorageSync('schoolName');}
		uni.getProvider({
