...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const goSelcetSchool = () => {
      common_vendor.index.redirectTo({
        url: `/subpages/school/school`
      });
    };
    ...
    common_vendor.onLoad(async () => {
      if (common_vendor.index.getStorageSync("schoolId")) {
        store.SchoolId = common_vendor.index.getStorageSync("schoolId");
        store.SchoolName = common_vendor.index.getStorageSync("schoolName");
      }
    ...
    return (_ctx, _cache) => {
      return {
        a: common_vendor.t(common_vendor.unref(store).SchoolName),
        b: common_vendor.o(goSelcetSchool),
        c: common_vendor.f(common_vendor.unref(imageList), (item, index, i0) => {
          return {
            a: item.imageUrl,
            b: item.id
          };
        ...
        i: common_vendor.o(scrollStore),
        j: common_vendor.p({
          useSlot: true,
          text: "校园外卖"
        }),
        k: common_vendor.f(businessList.value, (i, index, i0) => {
          return {
        ...
        r: common_vendor.f(common_vendor.unref(StoreList), (i, index, i0) => {
          return {
        ...
        t: common_vendor.unref(loadShow)
      };
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/frontendcode/project/wx-Running/wx-Running-master/pages/index/index.vue"]]);
