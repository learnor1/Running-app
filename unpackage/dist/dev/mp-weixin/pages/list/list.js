      ...
      return {
        a: common_vendor.f(feedIndentList.value, (i, index2, i0) => {
          return {
            ...
            e: "73d204a0-3-" + i0 + "," + ("73d204a0-2-" + i0),
            f: common_vendor.p({
              type: "primary",
              disabled: i.user_id == common_vendor.unref(store).userId
            }),
            g: "73d204a0-2-" + i0 + ",73d204a0-1",
            h: common_vendor.p({
              price: i.money,
        ...
        e: common_vendor.f(otherIndentList.value, (i, index2, i0) => {
          return {
            ...
            d: "73d204a0-7-" + i0 + "," + ("73d204a0-6-" + i0),
            e: common_vendor.p({
              type: "primary",
              disabled: i.userId == common_vendor.unref(store).userId
            }),
            f: "73d204a0-6-" + i0 + ",73d204a0-5",
            g: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/wx-Running/wx-Running-master/pages/list/list.vue"]]);
