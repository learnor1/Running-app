...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const scrollBottom = () => {
      common_vendor.wx$1.createSelectorQuery().select("#bottom").boundingClientRect((res) => {
        console.log(res);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/wx-Running/wx-Running-master/subpages/conversation/conversation.vue"]]);
