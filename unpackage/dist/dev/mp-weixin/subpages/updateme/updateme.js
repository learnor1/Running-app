...
if (!Array) {
  ...
  (_component_van_field + _component_van_cell_group + _component_van_uploader + _component_van_button + _component_van_overlay)();
}
const _sfc_main = {
  __name: "updateme",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        e: common_vendor.o(update),
        f: common_vendor.p({
          type: "primary",
          round: true,
          size: "large"
        }),
        g: common_vendor.t(msg.value),
        h: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/wx-Running/wx-Running-master/subpages/updateme/updateme.vue"]]);
